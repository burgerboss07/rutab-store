...
import { Package, Heart, ShoppingBag, LogOut, User, Mail, Phone, MapPin, Edit3, Save, X } from 'lucide-react';
              ...
              <>
                ...
                <div className="space-y-1.5">
                  ...
                  <input value={editForm.phone} onChange={(e) => setEditForm(f => ({ ...f, phone: e.target.value }))}
                    className="w-full bg-black border border-white/10 rounded-xl py-2 px-3 text-sm text-white placeholder:text-[#555] focus:outline-none focus:border-[#ff0000]/40 transition" placeholder="+965 XXXX XXXX" />
                </div>
              </>
            ) : (
              <>
