...
export default function DashboardHome() {
  ...
  const d = {
    ...dashboardMock,
    salesAnalytics: {
      ...dashboardMock.salesAnalytics,
      revenueByCategory: hasData ? dashboardMock.salesAnalytics.revenueByCategory : dashboardMock.salesAnalytics.revenueByCategory.map(c => ({ ...c, value: 0 })),
      monthlyRevenue: hasData ? dashboardMock.salesAnalytics.monthlyRevenue : dashboardMock.salesAnalytics.monthlyRevenue.map(m => ({ ...m, revenue: 0, orders: 0 })),
      topProducts: hasData ? dashboardMock.salesAnalytics.topProducts : [],
    },
    inventory: hasData ? dashboardMock.inventory : [],
    customerSegments: hasData ? dashboardMock.customerSegments : [],
    payouts: hasData ? dashboardMock.payouts : [],
    liveActivity: hasData ? dashboardMock.liveActivity : [],
  };
