  ...
  return (
    <div className="pt-24 min-h-screen bg-black text-white px-6 max-w-7xl mx-auto pb-24">
      ...
      <div className="grid lg:grid-cols-[250px_1fr] gap-10 items-start">
        ...
        <aside className="hidden lg:block sticky top-28 h-[calc(100vh-7rem)] flex flex-col">
          <div className="flex-1 overflow-y-scroll no-scrollbar bg-[#0a0a0a] border border-white/5 rounded-[30px] p-6 shadow-xl space-y-8" style={{ overscrollBehavior: 'contain' }}>
